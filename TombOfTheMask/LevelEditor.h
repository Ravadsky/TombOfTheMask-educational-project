...
private:
	...
	const sf::Vector2f MaxCameraPos = { sf::Vector2f(MAX_LEVEL_SIZE * SPRITE_GAME_SIZE - SPRITE_GAME_SIZE / 2, MAX_LEVEL_SIZE * SPRITE_GAME_SIZE - SPRITE_GAME_SIZE / 2 ) - CAMERA_PIVOT };
